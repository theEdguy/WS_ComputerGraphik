...
/*   SquareMatrix4df world_transformation =
  ...
  if (game.ship_exists() && game.get_ship() != nullptr) {
    ...
    // Translation: verschiebe alle Objekte so, dass das Schiff in der Mitte ist (Fenster: 512,384)
  ...
  //hier 3
  // 9-fach Tiling: alle Views in 9 Kacheln zeichnen
  for (int t = 0; t < 9; ++t) {
  ...
  // Score und freie Schiffe bleiben fix
