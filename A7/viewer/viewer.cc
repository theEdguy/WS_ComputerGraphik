...
/*     std::string obj_path = "teapot.obj";
    std::string mtl_path = "basic.mtl"; */

    // Space Ship
    std::string obj_path = "space_ship.obj";
    std::string mtl_path = "space_ship.mtl";

    // Asteroid
/*     std::string obj_path = "asteroid.obj";
    std::string mtl_path = "asteroid.mtl"; */

    // Torpedo
/*     std::string obj_path = "torpedo.obj";
    std::string mtl_path = "torpedo.mtl"; */

/*     // UFO
    std::string obj_path = "ufo.obj";
    std::string mtl_path = "ufo.mtl"; */


    std::fstream in(obj_path);
